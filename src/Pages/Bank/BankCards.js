...
const BankCards = () => {
  return (
    <div className="flex justify-center gap-4 mt-12 items-center flex-col lg:flex-row  p-4">
      <div className="bg-secondary  w-[300px] rounded-xl">
        <div className="flex justify-start p-8  flex-col">
          <p
            ...
            className="font-semibold text-2xl  text-start"
          >
            Easy <br />
            integration
          </p>
          ...
          <p
            ...
            data-aos-easing="linear"
            data-aos-duration="1500"
            className="text-sans opacity-80 mt-4 text-start text-sm font-medium"
          >
        ...
        <div className="my-12">
          <div
            ...
            data-aos-easing="linear"
            data-aos-duration="1500"
            className="flex flex-row my-7 justify-between items-center"
          >
          ...
          >
            ...
            <img
              src={Mastercard}
              alt=""
              className="bg-slate-50 rounded-md h-6"
            />
      ...
      <div className="bg-secondary  w-[300px] rounded-xl pb-10">
        <div className="flex justify-start p-8  flex-col">
          <p
            data-aos="flip-up"
            data-aos-easing="linear"
          ...
          <p
            ...
            data-aos-easing="linear"
            data-aos-duration="1500"
            className="text-sans opacity-80  py-6 text-start text-sm font-medium"
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do.
          </p>
        </div>
        ...
        <div className="flex flex-row my-3 justify-center items-center gap-4">
          <img
            ...
            src={laptop}
            alt=""
            className=" bg-green-200 rounded-md h-24 p-4 w-24"
          />
          <img
            data-aos="zoom-in"
            data-aos-easing="linear"
            ...
            src={bike}
            alt=""
            className="bg-red-100 rounded-md h-24 p-4 w-24"
          />
        </div>
      ...
      <div className="bg-secondary w-[300px] rounded-xl">
        <div className="flex justify-start p-8  flex-col">
          ...
          <p
            ...
            data-aos-easing="linear"
            data-aos-duration="1500"
            className="text-sans opacity-80 mt-2 text-start text-sm font-medium"
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do.
          </p>
        </div>
        ...
        data-aos-easing="linear"
        data-aos-duration="1200" className="flex justify-around items-center gap-4 mb-3 bg-white px-2 rounded-lg">
          ...
          <div data-aos="fade-up"
        data-aos-easing="linear"
        data-aos-duration="1500" className="flex justify-around items-center gap-4 mb-2 bg-white p-2 rounded-lg">
            <div className="flex justify-start items-center gap-5">
              <div className="bg-primary text-white rounded-md p-3">
                <FaAmazon />
              </div>
          ...
          <div data-aos="fade-up"
        data-aos-easing="linear"
        data-aos-duration="1800" className="flex justify-around items-center gap-4 mb-2 bg-white p-2 rounded-lg">
            <div className="flex justify-start items-center gap-5">
              <div className="bg-primary text-white rounded-md p-3">
                <FaGoogle />
              </div>
