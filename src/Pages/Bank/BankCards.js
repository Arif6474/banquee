...
const BankCards = () => {
    return (
        <div className="flex justify-center gap-8 mt-12 items-center flex-row mx-48 p-4">
            ...
            <p className="text-sans opacity-80 mt-2 text-start text-xs font-medium">
            ...
            <p className="text-sans opacity-80 mt-2 pb-8 text-start text-xs font-medium">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do.
            </p>
          </div>
                
                    <div className="flex flex-row my-4 justify-center items-center gap-4">
